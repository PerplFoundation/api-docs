...
// see the JavaScript example enroll_api_key.js.
...
export function loadApiKey(): ApiKeyCredentials {
...
export async function signedFetch(method: string, target: string, body: string = ''): Promise<Response> {
